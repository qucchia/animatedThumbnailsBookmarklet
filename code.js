...
let customThumbnailMain = () => {
    let snackBarCSS = () => {
        ...
        css.innerHTML = '#snackbar { visibility: hidden; min-width: 250px; margin-left: -125px; background-color: white; color: #585f76; text-align: center; border-radius: 2px; padding: 16px; position: fixed; z-index: 1; left: 50%; top: 50px; } #snackbar.show { visibility: visible; } #uploadthumbnail { visibility: hidden; } ';
