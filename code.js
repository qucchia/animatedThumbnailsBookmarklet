...
function customThumbnailMain() {
    function snackBarCSS() {
        ...
        css.innerHTML = '#snackbar { visibility: hidden; align: center; min-width: 250px; background-color: white; color: #585f76; text-align: center; border-radius: 10px; padding: 16px; position: fixed; z-index: 1; left: 50%; top: 60px; } #snackbar.show { visibility: visible; } #uploadthumbnail { visibility: hidden; } ';
