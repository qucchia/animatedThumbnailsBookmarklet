...
function customThumbnailMain() {
    function snackBarCSS() {
        ...
        css.innerHTML = '#snackbar { visibility: hidden; border-radius: 10px; min-width: 250px; margin-left: 50%; background-color: white; color: #585f76; text-align: center; border-radius: 2px; padding: 16px; position: fixed; z-index: 1; left: 50%; top: 50%; } #snackbar.show { visibility: visible; } #uploadthumbnail { visibility: hidden; } ';
